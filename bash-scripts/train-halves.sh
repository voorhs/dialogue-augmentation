...
--finetune-layers 3 \
--loss contrastive_symmetric \
--name bert-advanced-fair-halves \
--halves
...
--finetune-layers 3 \
--loss contrastive_symmetric \
--name roberta-trivial-fair-halves \
--halves
...
--finetune-layers 3 \
--loss contrastive_symmetric \
--name roberta-advanced-fair-halves \
--halves
...
--finetune-layers 3 \
--loss contrastive_symmetric \
--name roberta-crazy-fair-halves \
--halves
...
--finetune-layers 3 \
--loss contrastive_symmetric \
--name retromae-trivial-fair-halves \
--halves
...
--finetune-layers 3 \
--loss contrastive_symmetric \
--name retromae-advanced-fair-halves \
--halves
...
--finetune-layers 3 \
--loss contrastive_symmetric \
--name retromae-crazy-fair-halves \
--halves
